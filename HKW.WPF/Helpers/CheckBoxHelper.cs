...
//        {
//            _checkBoxGroups[topParent] = groups = new();
...
//                return;
//            var groups = _checkBoxGroups[element];
//            foreach (var groupInfo in groups)
//            {
//                var group = groupInfo.Value;
//                foreach (var checkBox in groupInfo.Value.SubCheckBoxes)
//                {
//                    if (GetCheckGroupLeader(checkBox) == groupInfo.Key && group.Leader != checkBox)
//                    {
//                        if (group.Leader is not null)
//                            throw new Exception(
//                                $"CheckBox group: {groupInfo.Key} leader already exists"
//                            );
